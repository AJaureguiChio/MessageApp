      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              LanguageService.textJsonReference("welcome_admin") + email,
              style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 20),
            Text(
              LanguageService.textJsonReference("exclusive_functions_admin"),
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      LanguageService.textJsonReference("admin_function"),
                    ),
                  ),
                );
              },
              child: Text(
                LanguageService.textJsonReference("administrate_users"),
              ),
            ),
          ],
        ),
