...
// import '../services/webrtc_service.dart'; // Para la llamada
...
class UsersListScreen extends StatelessWidget {
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            ...
                            _acceptCall(context, currentUid);
                          },
  ...
  /* Escucha si hay una oferta dirigida a mí */
  ...
  /* Aceptar: abrir CallScreen en modo receptor */
  void _acceptCall(BuildContext context, String myUid) async {
